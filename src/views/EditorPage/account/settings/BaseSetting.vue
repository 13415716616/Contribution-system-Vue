      ...
      <a-col :md="24" :lg="16">
        ...
        <a-form layout="vertical">
          <a-form-item label="姓名" >
            <a-input placeholder="请输入你的姓名" v-model="editor.editor_Name" />
          </a-form-item>

          <a-form-item label="性别">
            <a-select style="width: 120px" v-model="editor.editor_Sex">
          ...
          <a-form-item label="学历">
            <a-select style="width: 120px" v-model="editor.editor_Education">
          ...
          <a-form-item label="电子邮件" :required="false" >
            <a-input placeholder="exp@admin.com" v-model="editor.editor_Email"/>
          </a-form-item>
          <a-form-item
            label="电话号码"
            :required="false"
          >
            <a-input placeholder="请输入电话号码" v-model="editor.editor_Phone"/>
          </a-form-item>

          <a-form-item
            label="个人简介"
          >
            <a-textarea rows="4" placeholder="请输入你的个人简介" v-model="editor.editor_Dec"/>
          </a-form-item>
