      ...
      <div class="ant-pro-pages-list-projects-cardList">
        <a-list :loading="loading" :data-source="data" :grid="{ gutter: 24, xl: 4, lg: 3, md: 3, sm: 2, xs: 1 }">
          <a-list-item slot="renderItem" slot-scope="item">
            <a-card class="ant-pro-pages-list-projects-card" hoverable style="width:250px" @click="Show(item.manuscript_ID)">
              <img slot="cover" :height="200" :src="'https://localhost:5001'+item.avtor" :alt="item.manuscript_Title" />
